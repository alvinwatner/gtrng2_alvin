...
//
//     final detailPokemonResponse = detailPokemonResponseFromJson(jsonString);

// import 'package:meta/meta.dart';
import 'dart:convert';

DetailPokemonResponse detailPokemonResponseFromJson(String str) => DetailPokemonResponse.fromJson(json.decode(str));

String detailPokemonResponseToJson(DetailPokemonResponse data) => json.encode(data.toJson());
...
class DetailPokemonResponse {
    ...
    factory DetailPokemonResponse.fromJson(Map<String, dynamic> json) => DetailPokemonResponse(
...
class Sprites {
    ...
    factory Sprites.fromJson(Map<String, dynamic> json) => Sprites(
        ...
        animated: (json["animated"] != null) ?  Animated.fromJson(json["animated"]) : null,
    );
